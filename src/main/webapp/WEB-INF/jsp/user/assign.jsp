			  ...
			  <div class="panel-body">
				...
				<input type="hidden" name="userid" value="${user.id }">
				  <div class="form-group">
					...
					<select id="leftList" name="unassginroLeids" class="form-control" multiple size="10" style="width:200px;overflow-y:auto;">
				  ...
				  <div class="form-group" style="margin-left:40px;">
					...
					<select id="rightList" name="assginroLeids" class="form-control" multiple size="10" style="width:200px;overflow-y:auto;">
        ...
        <script type="text/javascript">
            $(function () {
				...
				$("#left2RightBtn").click(function(){
					...
					if(opts.length == 0){
						layer.msg("请选择需要分配的角色信息", {time:2000, icon:5, shift:6}, function(){
							...
							$.ajax({
								...
								success:function(result){
									if(result.success){
										...
										layer.msg("分配的角色成功", {time:2000, icon:6}, function(){
					                    	
					                    });
										}else{
											layer.msg("分配的角色失败", {time:2000, icon:5, shift:6}, function(){
							...
							$.ajax({
								...
								success:function(result){
									if(result.success){
										...
										layer.msg("取消分配的角色成功", {time:2000, icon:6}, function(){
					                    	
					                    });
										}else{
											layer.msg("取消分配的角色失败", {time:2000, icon:5, shift:6}, function(){
